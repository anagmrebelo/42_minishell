...
/*   Updated: 2023/02/09 22:08:47 by arebelo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
static void	insert_in_list(t_command *member, t_master *master)
{
	t_command	*temp;
 ...
 * Stored in t_master
*/
static int	count_commands(t_master *master)
{
	int		i;
	t_token	*temp;
...
*/
static t_token	*find_next_pipe(t_token *temp)
{
...
static t_token	*adding_sort(t_token *temp, t_command *cmd,
